...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        """Train the nerual network using mini batch stochastic gradient descent.
        ...
        but slos things down substantially."""
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        the mini_batch is list of tuples x,y and eta is the learning rate"""
    ...
    def backprop(self, x, y):
        """Return a tuple nablea_b, nabla_w representing the gradient
    ...
    def evaluate(self, test_data):
        """Return the number of test inputs for which th neural
